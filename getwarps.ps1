...
if ($gamePath -ne "") {
    ...
    Copy-Item -Path "$gamePath/StarRail_Data/webCaches/Cache/Cache_Data/data_2" -Destination "$gamePath/StarRail_Data//webCaches/Cache/Cache_Data/data_2_copy"
    $cacheData = Get-Content -Encoding UTF8 -Raw "$gamePath/StarRail_Data//webCaches/Cache/Cache_Data/data_2_copy"
    Remove-Item -Path "$gamePath/StarRail_Data//webCaches/Cache/Cache_Data/data_2_copy"
